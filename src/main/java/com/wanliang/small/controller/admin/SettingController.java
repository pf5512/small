...
import com.wanliang.small.Setting.AccountLockType;
import com.wanliang.small.Setting.CaptchaType;
import com.wanliang.small.Setting.ConsultationAuthority;
import com.wanliang.small.Setting.ReviewAuthority;
import com.wanliang.small.Setting.RoundType;
import com.wanliang.small.Setting.StockAllocationTime;
import com.wanliang.small.Setting.WatermarkPosition;
import com.wanliang.small.service.CacheService;
import com.wanliang.small.service.FileService;
import com.wanliang.small.service.MailService;
		...
		try {
			...
			if (setting.getIsDevelopmentEnabled()) {
				if (!templateUpdateDelay.equals("0") || !messageCacheSeconds.equals("0")) {
					...
					properties.store(outputStream, "wan_liang@126.com PROPERTIES");
				}
			} else {
				if (templateUpdateDelay.equals("0") || messageCacheSeconds.equals("0")) {
					outputStream = new FileOutputStream(resource.getFile());
