...
import com.wanliang.small.entity.ArticleCategory;
import com.wanliang.small.entity.Product;
import com.wanliang.small.entity.ProductCategory;
import com.wanliang.small.service.ArticleCategoryService;
import com.wanliang.small.service.ArticleService;
	...
	Map<String, Object> build(BuildType buildType, Long articleCategoryId, Long productCategoryId, Date beginDate, Date endDate, Integer first, Integer count) {
		...
		if (beginDate != null) {
			Calendar calendar =Calendar.getInstance();
			 calendar.setTime(beginDate); //DateUtils.toCalendar(beginDate);
		...
		if (endDate != null) {
			...
			Calendar calendar =Calendar.getInstance();
			 calendar.setTime(endDate); //DateUtils.toCalendar(endDate);
