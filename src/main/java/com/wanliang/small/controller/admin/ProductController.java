...
import com.wanliang.small.*;
import com.wanliang.small.entity.*;
import com.wanliang.small.entity.Message;
import com.wanliang.small.service.*;
import com.wanliang.small.util.SettingUtils;
import com.wanliang.small.FileInfo.FileType;
...
import com.wanliang.small.entity.ProductImage;
...
import com.wanliang.small.service.FileService;
import com.wanliang.small.service.GoodsService;
import com.wanliang.small.service.MemberRankService;
import com.wanliang.small.service.ProductCategoryService;
import com.wanliang.small.service.ProductImageService;
import com.wanliang.small.service.ProductService;
import com.wanliang.small.service.PromotionService;
import com.wanliang.small.service.SpecificationService;
import com.wanliang.small.service.SpecificationValueService;
import com.wanliang.small.service.TagService;
import com.wanliang.small.util.SettingUtils;
...
public class ProductController extends BaseController {
		...
		for (Iterator<ProductImage> iterator = product.getProductImages().iterator(); iterator.hasNext();) {
			...
			if (productImage.getFile() != null && !productImage.getFile().isEmpty()) {
				if (!fileService.isValid(FileInfo.FileType.image, productImage.getFile())) {
					addFlashMessage(redirectAttributes, com.wanliang.small.Message.error("admin.upload.invalid"));
	...
	public @ResponseBody
    com.wanliang.small.Message delete(Long[] ids) {
