...
import com.wanliang.small.Setting.StockAllocationTime;
...
import com.wanliang.small.dao.MemberRankDao;
import com.wanliang.small.dao.OrderDao;
...
import com.wanliang.small.entity.GiftItem;
import com.wanliang.small.entity.Member;
import com.wanliang.small.entity.MemberRank;
import com.wanliang.small.entity.Order;
import com.wanliang.small.entity.Order.OrderStatus;
import com.wanliang.small.entity.Order.PaymentStatus;
import com.wanliang.small.entity.Order.ShippingStatus;
import com.wanliang.small.entity.OrderItem;
import com.wanliang.small.entity.OrderLog;
import com.wanliang.small.entity.OrderLog.Type;
...
import com.wanliang.small.entity.ReturnsItem;
import com.wanliang.small.entity.Shipping;
import com.wanliang.small.entity.ShippingItem;
import com.wanliang.small.entity.ShippingMethod;
import com.wanliang.small.entity.Sn;
...
public class OrderServiceImpl extends BaseServiceImpl<Order, Long> implements OrderService {
	...
	@Transactional(readOnly = true)
	public List<Order> findList(Member member, Integer count, List<Filter> filters, List<com.wanliang.small.Order> orders) {
		...
		for (OrderItem orderItem : order.getOrderItems()) {
			if (orderItem != null) {
				...
				if (product != null) {
                    ...
                    Calendar weekSalesCalendar=Calendar.getInstance();
                    weekSalesCalendar.setTime(product.getWeekSalesDate());
					//Calendar weekSalesCalendar =product.getWeekSalesDate(); //DateUtils.toCalendar(product.getWeekSalesDate());
                    Calendar  monthSalesCalendar=Calendar.getInstance();
                    monthSalesCalendar.setTime(product.getMonthSalesDate());
