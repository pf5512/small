	...
	private void updateHits() {
		...
		for (Long id : ids) {
			...
			if (product != null) {
                ...
                Calendar weekHitsCalendar=Calendar.getInstance();
                weekHitsCalendar.setTime(product.getWeekHitsDate());
                //Calendar weekSalesCalendar =product.getWeekSalesDate(); //DateUtils.toCalendar(product.getWeekSalesDate());
                Calendar  monthHitsCalendar=Calendar.getInstance();
                monthHitsCalendar.setTime(product.getMonthHitsDate());
