...
import com.wanliang.small.service.SearchService;
import com.wanliang.small.Page;
import com.wanliang.small.Pageable;
import com.wanliang.small.dao.ArticleDao;
import com.wanliang.small.dao.ProductDao;
import com.wanliang.small.entity.Article;
import com.wanliang.small.entity.Product;
...
public class SearchServiceImpl implements SearchService {
	...
	public Page<Article> search(String keyword, Pageable pageable) {
		...
		try {
			String text = QueryParser.escape(keyword);//.LUCENE_35
			QueryParser titleParser = new QueryParser(Version.LUCENE_30, "title", new IKAnalyzer());
	...
	public Page<Product> search(String keyword, BigDecimal startPrice, BigDecimal endPrice, Product.OrderType orderType, Pageable pageable) {
		...
		try {
			...
			TermQuery snQuery = new TermQuery(new Term("sn", text));//.LUCENE_35
			Query keywordQuery = new QueryParser(Version.LUCENE_30, "keyword", new IKAnalyzer()).parse(text);
			QueryParser nameParser = new QueryParser(Version.LUCENE_30, "name", new IKAnalyzer());
